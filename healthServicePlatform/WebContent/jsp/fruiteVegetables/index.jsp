		  ...
		  <div class="layui-form-item">
				   <!--  <div class="layui-input-block">
				    ...
				    <div class="layui-btn-group" style="border-left: 20px;">
						  ...
						  <button class="layui-btn" lay-submit lay-filter="add" id="export">导出</button>
                   </div>
				    </div>
					...
					<tbody>
						<c:forEach items="${pageInfos.list}" var="obj" varStatus="xh">
							<tr>
								...
								<td>${obj.drinking}</td>
								<td>
								<a href="${ctx}/dayCookBook/deleteDayCookBookById/${obj.id}" class="layui-btn layui-btn-danger layui-btn-xs"><i class="layui-icon">&#xe640;</i></a>
    ...
    layui.use(['element','form','jquery','layer'], function(){
     ...
     //分页功能的结束==========================
    	 ...
    	 $("#export").click(function(){
    		 window.location = "${ctx}/dayCookBook/exportCookBook";
    	 })
