...
<div class="layui-layout layui-layout-admin">
 <jsp:include page="/jsp/common/header.jsp"></jsp:include>
  <div class="layui-body">
			...
			<form class="layui-form" action="${ctx}/aerobicMovement/addAerobicMovement" method="post">
				<div class="layui-form-item">
			      ...
			      <div class="layui-input-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="movementTime" 
							placeholder="输入运动时长(分钟)" autocomplete="off" class="layui-input">
					</div>
