		...
		<%-- <form action="${ctx}/physicalExamination/personPhysicalExamination" method="post">
		  ...
		  <div class="layui-form-item">
				    <div class="layui-input-block">
				      <a href="${ctx}/aerobicMovement/toAddAerobicMovement" class="layui-btn " style="border-left: 20px;">录入有氧运动信息</a>
				    </div>
				 </div>
    ...
    layui.use(['element','form','jquery','layer'], function(){
    	...
    	//=============分页功能的实现=================
  		$('a[page]').click(function(){		
  			...
  			//跟新玩之后整体的提交表单
  			$('form').submit(); */
  			window.location = "${ctx}/aerobicMovement/queryAerobicMovement/"+pageNum;
  		});
     //分页功能的结束==========================
