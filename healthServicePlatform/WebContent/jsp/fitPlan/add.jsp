...
<div class="layui-layout layui-layout-admin">
 <jsp:include page="/jsp/common/header.jsp"></jsp:include>
  <div class="layui-body">
			...
			<form class="layui-form" action="${ctx}/fitPlan/addFitPlan" method="post">
				<div class="layui-form-item">
					<label class="layui-form-label">健身目的</label>
					<div class="layui-input-inline">
						<input type="text" name="attention" 
							placeholder="输入健身目的" autocomplete="off" class="layui-input">
					</div>
					<label class="layui-form-label">健身强度</label>
					<div class="layui-input-inline">
						<input type="text" name="strength" 
							placeholder="输入健身强度" autocomplete="off" class="layui-input">
					</div>
					<label class="layui-form-label">健身频率</label>
					<div class="layui-input-inline">
						<input type="text" name="frequency" 
							placeholder="输入健身频率" autocomplete="off" class="layui-input">
					</div>	
				</div>
				<div class="layui-form-item">
						...
						<input type="text" name="fixedTime" 
							placeholder="输入健身时间点" autocomplete="off" class="layui-input">
					</div>
					<label class="layui-form-label">健身方法</label>
						<div class="layui-input-inline">
						 <select name="methodName" lay-verify="required">
					        <option value=""></option>
					        <c:forEach items="${fitMethods}" var="obj">
					            <option value="${obj.fitName}">${obj.fitName}</option>
					        </c:forEach> 
					      </select>
					</div>
				</div>
