...
<!-- 使用JSTL标签库和EL表达式，完成在页面中的显示出来
application中存放的是一个list集合，集合中存放的是book对象，所以需要
循环遍历list的集合，拿到book对象。
JSTL的作用是循环遍历的功能JSP+标准+tag+lib，是取出list集合的对象
 -->
</head>
<body>
	<!--顶部-->
					...
					<c:forEach items="${allBooks}" var="book">
						<li class="c4_b5_c_box">
							...
							<ul class="c4b5_option">
								<li class="shopcar_box"><span class="shopcar01"></span><a href="shoppingCartAdd.action?book_id=${book.id }">加入购物车</a></li>
							</ul>
						</li>
					</c:forEach>
				</ul>
